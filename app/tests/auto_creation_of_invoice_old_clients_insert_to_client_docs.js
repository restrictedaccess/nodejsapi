                        ...
                        try{
                            ...
                            InvoiceModel.findOne({}).exec(function(err, createdInvoice){
                                ...
                                try {
                                    ...
                                    expect(createdInvoice.pay_before_date ).to.equalDate(moment("2017-06-09T00:00.00Z").toDate());
                                    ...
                                    expect(createdInvoice.sub_total).to.equal(1671.2);
                                    expect(createdInvoice.gst_amount).to.equal(167.12);
                                    expect(createdInvoice.total_amount).to.equal(1838.32);
                                    ...
                                    expect(third_item.description).to.equal("Currency Adjustment (Contract Rate 1 AUD = 38 PESO VS Current Rate 1 AUD = 37.5 PESO, Currency Difference of 0.5  PESO for your staff Efigenio IV Rodriguez)(Actual Working Hours of 184 from May 1, 2017 to May 31, 2017)(Hourly Rate 9.37)/Current Rate 37.5");
                                    ...
                                    expect(third_item.amount).to.equal(22.08);
