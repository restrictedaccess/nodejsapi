...
describe("System syncs invoices to xero.com as Invoice", function(){
    ...
    describe("2 Invoices is updated in or system and xero responds with an error [Unappy Path] When Xero Clients responds with a 503 error code", function(){
                ...
                Q.allSettled(all_given_creation_promises).then(function(results){
                    ...
                    xero_bull.processBatchInvoices(
                        ...
                        function(err, response){
                            ...
                            xeroInvoiceErrorsObj.getOneData("batch_saving_error", true).then(function(xero_error){
                                try{
