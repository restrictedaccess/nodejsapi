...
describe("System syncs clients to xero.com as contacts", function(){
    ...
    //Scenario 1
    describe("Client’s Information is updated in our system (Happy Path)", function(){
        it("should be saving to our system", function(done){
            ...
            var existing_xero_contact_mongo = {
            ...
            all_given_saving_promises.push(helper.createMongoObject("xero", "XeroContact", xeroContactSchema, existing_xero_contact_mongo));
                                                ...
                                                entities: [
                                                    {
                                                        toJSON: function(){
                                                            return {
                                                                ContactID: existing_xero_contact_mongo.ContactID,
                                                                ContactNumber: client.id.toString(),
                    ...
                    function(error, response){
                        ...
                        xeroContactObj.getOneData(client.id, true).then(function(synced_client){
                            ...
                            try{
                                ...
                                expect(synced_client.ContactID).to.be.equal("33be2ffa-dc57-46ad-a688-4b66ff46c20f");
                                ...
                                expect(synced_client.EmailAddress).to.be.equal("davidimrie02@mcgrath.com.au");
