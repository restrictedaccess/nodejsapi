...
var xeroInvoicesErrorsSchema = require("../models/XeroInvoiceErrors");
...
describe("System syncs cancelled invoices to xero.com as Voided Invoice", function(){
    ...
    describe("An admin cancells an invoice but xero.com responds with a 503 response[Happy Path] When The xero client responds with a 503 error code", function(){
                ...
                Q.allSettled(all_given_creation_promises).then(function(results){
                    ...
                    xero_bull.processPerInvoice(
                        ...
                        function(err, response){
                            ...
                            var XeroInvoiceErrorsModel = db_xero.model("XeroInvoiceErrors", xeroInvoicesErrorsSchema);
                            ...
                            xeroInvoiceErrorsObj.getOneData(invoice_details.order_id, true).then(function(voided_invoice){
                                try{
                                    expect(voided_invoice.InvoiceNumber).to.be.equal("14076-00000006");
                                    expect(voided_invoice.ErrorMessage).to.have.string('Server Unavailable');
